...
const Products = () => {
  ...
  useEffect(() => {
    ...
    window.addEventListener('produtoAtualizado', handleProdutoAtualizado as EventListener);
    window.addEventListener('estoqueAtualizado', handleEstoqueAtualizado as EventListener);
    ...
    return () => {
      ...
      window.removeEventListener('produtoAtualizado', handleProdutoAtualizado as EventListener);
      window.removeEventListener('estoqueAtualizado', handleEstoqueAtualizado as EventListener);
    };
  }, []);
  ...
  const loadProducts = async () => {
    try {
      const { data, error } = await supabase
        .from('produtos')
        .select('*')
        .gt('quantidade', 0) // Apenas produtos em estoque
        ...
        setProducts([
          {
            ...
            descricao: "Prancha profissional para surfistas experientes com tecnologia avançada",
            preco: 1299.99,
            quantidade: 15,
            categoria: "Pranchas",
            imagem_url: "https://images.unsplash.com/photo-1544551763-46a013bb70d5?w=500&h=300&fit=crop"
          },
          {
            id: '2',
            ...
            quantidade: 8,
            categoria: "Pranchas",
            imagem_url: "https://images.unsplash.com/photo-1502680390469-be75c86b636f?w=500&h=300&fit=crop"
          },
          {
            id: '3',
            ...
            quantidade: 12,
            categoria: "Wetsuits",
            imagem_url: "https://images.unsplash.com/photo-1571019613454-1cb2f99b2d8b?w=500&h=300&fit=crop"
          },
          {
            id: '4',
            ...
            imagem_url: "https://images.unsplash.com/photo-1502933691298-84fc14542831?w=500&h=300&fit=crop"
          },
          {
            id: '5',
            ...
            quantidade: 18,
            categoria: "Acessórios",
            imagem_url: "https://images.unsplash.com/photo-1544551763-77ef2d0cfc6c?w=500&h=300&fit=crop"
          },
          {
            id: '6',
            nome: "Cera Surf Tropical Premium",
            descricao: "Cera especial para águas tropicais com aderência perfeita",
            preco: 24.99,
            quantidade: 50,
            categoria: "Acessórios",
            imagem_url: "https://images.unsplash.com/photo-1506905925346-21bda4d32df4?w=500&h=300&fit=crop"
          }
        ]);
      } else {
        setProducts(data || []);
      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
            Equipamentos de alta qualidade selecionados especialmente para surfistas apaixonados
          </p>
        ...
        {loading ? (
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {products.map((product) => (
              <Card key={product.id} className="group hover:shadow-[var(--shadow-ocean)] transition-all duration-500 hover:-translate-y-2">
                ...
                <CardContent>
                  <p className="text-muted-foreground mb-4 line-clamp-2">{product.descricao}</p>
                  ...
                  <div className="mb-3">
                    <Button
                      ...
                      disabled={product.quantidade <= 0 || getItemQuantity(product.id) >= product.quantidade}
                  ...
                  <div className="mt-2">
                    <span className={`inline-block px-2 py-1 rounded text-xs ${
                      ...
                      {product.quantidade > 0 ? `${product.quantidade} em estoque` : 'Esgotado'}
                    </span>
                  </div>
                </CardContent>
              </Card>
